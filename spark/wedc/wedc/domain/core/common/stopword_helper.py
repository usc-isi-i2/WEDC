...
def get_stopword_set():
    stops = get_nltk_stopwords() + get_punctuations() + get_custom_stopwords()
...
def get_custom_stopwords(stops=None):
    custom_stops = ['us', 'im']
    if stops:
        custom_stops += stops
    return custom_stops
